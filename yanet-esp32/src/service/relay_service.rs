...
//
//use yanet::{Authenticated, Channel, Named, Transport, Upgrade};
//
...
//}
//
//impl Named for RelayService {
//    fn name(&self) -> &str {
//        "relay"
//    }
//}
//
//impl<C: Channel + Authenticated> Upgrade<C> for RelayService {
//    type Output = ();
